...
public class ContactCreationTests {
  ...
  public void testContactCreation() throws Exception {
    initContactCreation();
    fillContactForms(new ContactData("Dmytro", "Rudenko", "Ukraine Kiev", "38044", "38063", "38066", "38097", "fel_1@gmail.com", "fel_2@gmail.com", "fel_3@gmail.com", "6", "September", "1989"));
  ...
  private void fillContactForms(ContactData contactData) {
    ...
    wd.findElement(By.name("fax")).sendKeys(contactData.getTelfax());
    wd.findElement(By.name("email")).click();
    wd.findElement(By.name("email")).clear();
    wd.findElement(By.name("email")).sendKeys(contactData.getEmailfirst());
    wd.findElement(By.name("email2")).clear();
    wd.findElement(By.name("email2")).sendKeys(contactData.getEmailsecond());
    wd.findElement(By.name("email3")).clear();
    wd.findElement(By.name("email3")).sendKeys(contactData.getEmailthird());
